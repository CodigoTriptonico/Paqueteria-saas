...
export function AgencyPublicPricePanel() {
  ...
  return <div className="mx-auto w-full max-w-[1500px] space-y-4 p-3 sm:p-5">
    <div className="flex items-center gap-2"><Link href="/agencia" className={`${secondaryButtonClass} w-fit`}><ArrowLeft className="h-4 w-4" /> Mi agencia</Link><CompactInfoDisclosure ariaLabel={`Información de precios de ${data.agencyName}`}>Revisa lo que le debes a la matriz, elige tu precio al público y mira tu ganancia por cada caja.</CompactInfoDisclosure></div>
