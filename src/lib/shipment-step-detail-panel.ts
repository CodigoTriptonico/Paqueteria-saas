export const SHIPMENT_STEP_DETAIL_PANEL_TOP_OFFSET_PX = 68;
export const SHIPMENT_STEP_DETAIL_PANEL_GAP_PX = 12;
export const SHIPMENT_STEP_DETAIL_PANEL_ARROW_HALF_WIDTH_PX = 8;
