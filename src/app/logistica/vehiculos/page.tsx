...
export default async function LogisticaVehiculosPage() {
  const session = await requirePathAccess("/logistica/vehiculos");

  if (!isSupabaseConfigured() || !session) {
    return <LogisticsFleetAdminClient view="vehicles" />;
  }
