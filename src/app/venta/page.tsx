      ...
      {contextMenu ? (
        ...
        >
          ...
          <div className="group relative mt-1">
            ...
            <div className="invisible absolute left-[calc(100%-1px)] top-0 z-50 w-64 rounded-xl border border-slate-200 bg-white p-2 opacity-0 shadow-2xl delay-300 duration-150 group-hover:visible group-hover:opacity-100 group-hover:delay-0 dark:border-slate-700 dark:bg-slate-900">
